...
class Transaksi extends CI_Controller{
  ...
  public function index(){
    $data['transaksi'] = $this->db->query("SELECT *, (tr.harga * tr.lama_sewa) as totalpembayaran  FROM transaksi tr, mobil mb, customer cs, tipe tp WHERE tr.id_mobil=mb.id_mobil  AND tr.id_customer=cs.id_customer AND tp.id_tipe = mb.id_tipe")->result();
